...
export const BASE_MAP_COLORS = [
  ...
  {
    color: 'rgba(248, 115, 81, 1)',
    from: 11,
    to: 20,
  },
  {
    color: 'rgba(248, 134, 81, 1)',
    from: 21,
    to: 30,
  },
  {
    color: 'rgba(248, 156, 81, 1)',
    from: 31,
    to: 40,
  },
  {
    color: 'rgba(248, 187, 81, 1)',
    from: 41,
    to: 50,
  },
  {
    color: 'rgba(248, 220, 81, 1)',
    from: 51,
    to: 60,
  },
  {
    color: 'rgba(229, 248, 81, 1)',
    from: 61,
    to: 70,
  },
  {
    color: 'rgba(204, 248, 81, 1)',
    from: 71,
    to: 80,
  },
  {
    color: 'rgba(154, 248, 81, 1)',
    from: 81,
    to: 90,
  },
  {
    color: 'rgba(81, 248, 95, 1)',
    from: 91,
    to: 99,
  },
  {
    color: 'rgba(81, 248, 151, 1)',
    from: 100,
    to: 100,
  },
];
